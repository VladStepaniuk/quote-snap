...
export default function InboxPage() {
  ...
  const s = {
    ...
    filterBtn: (active) => ({ padding: "5px 14px", borderRadius: 20, border: "1px solid #e3e7ed", background: active ? "#4f46e5" : "#fff", color: active ? "#fff" : "#6d7175", fontWeight: 600, fontSize: "0.8rem", cursor: "pointer" }),
    layout: { display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 16, alignItems: "start" },
    list: { display: "flex", flexDirection: "column", gap: 8 },
    card: (active) => ({ background: "#fff", borderRadius: 10, padding: "14px 16px", border: `1px solid ${active ? "#4f46e5" : "#e3e7ed"}`, cursor: "pointer", transition: "border-color 0.15s" }),
    ...
    statusBtn: (active) => ({ padding: "5px 12px", borderRadius: 6, border: "1px solid #e3e7ed", background: active ? "#4f46e5" : "#f4f6f8", color: active ? "#fff" : "#374151", fontWeight: 600, fontSize: "0.8rem", cursor: "pointer" }),
